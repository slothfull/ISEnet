...
from q_tensor_name_lists_26 import se_chosen_excitations, sese_chosen_excitations, \
...
class ExcitationSummary:
    ...
    def push(self, sample_lst, xs, epoch):
        ...
        if epoch % 50 == 0 and epoch != 0:
            ...
            self.__save_tensor_for_statistics(excitation_12, 3, 3, epoch)
            self.__save_tensor_for_statistics(excitation_15, 4, 2, epoch)
        # write summaries
        ...
        self.writer.add_summary(summary, epoch)
        self.__excitation_line_chart(excitation_12, 3, 3)  # [n:(1,1,1,x) s:(1,1,1,x)...]
        self.__fig_to_rgb_array()
        ...
        self.writer.add_summary(summary, epoch)
        self.__excitation_line_chart(excitation_15, 4, 2)  # [n:(1,1,1,x) s:(1,1,1,x)...]
        self.__fig_to_rgb_array()
