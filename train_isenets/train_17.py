...
from q_summaries_classes_17 import PrecisionSummary, LossSummary, NetSummary  # ExcitationSummary 没有使用
...
num_train_samples = 45480  # todo to be defined
# path_ease = 'ch01/i17/res0/normal'
path_ease = 'i17p66'
epoch = 200
batch = 8
continue_training = '0'
num_iteration = float(num_train_samples // batch + 1)  # decay step=1 epoch =5526
...
def main():
    ...
    parser.add_argument('--v1', type=int, default=17, help='chosen form 6 10 14')
    ...
    parser.add_argument('--lr-values', type=str, default='0.0001;0.00009;0.00008;0.00005;0.000025;0.00001;0.000005', help='learning rate values')  # todo piecewise
    # todo 使用momentum优化器 通常要比adam优化器需要更大的 piecewise_lr 在每个"阶段"
    parser.add_argument('--lr-boundaries', type=str, default='55260;110520;221040;442080;884160;1768320', help='10:20:40:80:160:320 b=8')

    parser.add_argument('--lr-value', type=float, default=0.0001, help='learning rate for exp decay')
    ...
    parser.add_argument('--moving-average-decay', type=float, default=0.9995, help='moving avg decay')  # todo 降低decay 企图增加泛化能力
    ...
    with tf.Session(config=config) as sess:
        ...
        for e in range(start_epoch, args.epochs):
            ...
            # num = 4 * sveb_ppr + 5 * sveb_recall
            # if (e + 1) % args.checkpoint_interval == 0 and num >= pre_num and sveb_recall >= 0.6:
