...
from q_summaries_classes_23 import PrecisionSummary, LossSummary, NetSummary  # ExcitationSummary 没有使用
...
def main():
    ...
    parser.add_argument('--v1', type=int, default=23, help='chosen form 6 10 14')
