...
from q_summaries_classes_17 import PrecisionSummary, LossSummary, ExcitationSummary
...
def main():
    ...
    # todo do not change!
    parser.add_argument('--v1', type=str2bool, default=17, help='v1=18: res-18 | v1=34: res-34')
    # todo do not change!
