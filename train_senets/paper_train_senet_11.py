...
from q_summaries_classes_11 import PrecisionSummary, LossSummary, ExcitationSummary
...
def main():
    ...
    # todo do not change!
    parser.add_argument('--v1', type=str2bool, default=18, help='v1=18: res-18 | v1=34: res-34')
    # todo do not change!
