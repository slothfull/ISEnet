...
from q_summaries_classes_26 import PrecisionSummary, LossSummary, ExcitationSummary
...
def main():
    ...
    # todo do not change!
    parser.add_argument('--v1', type=str2bool, default=23, help='v1=18: res-18 | v1=34: res-34')
    # todo do not change!
    ...
    parser.add_argument('--weight-decay', type=float, default=0.0001, help='weight decay fro bn')
