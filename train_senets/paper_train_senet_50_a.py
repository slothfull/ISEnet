...
# -*- coding:utf-8 -*-
"""
@time:2019/3/9 下午11:04
@author:bigmelon

todo this script is for building excitation & precision & loss summaries
todo but a problem occurs that: once restore the training-step from checkpoint, the acc & loss return to the primary state

todo https://stackoverflow.com/questions/42029046/tensorflow-batch-loss-spikes-when-restoring-model-for-training-from-saved-checkp
todo 上述问题的原因是 没有考虑到 restore的时候 global_variables如何进行初始化...
"""
...
from q_net_utils_50 import build_from_metagraph, build_optimizer_from_metagraph, build_model_and_optimizer, initialize_uninitialized_variables
from q_summaries_classes_50 import PrecisionSummary, LossSummary, ExcitationSummary
...
def main():
    ...
    # todo do not change!
    parser.add_argument('--v1', type=str2bool, default='0', help='v1=0: res_v2 | v1=1:res-v1')
    # todo do not change!
    ...
    print('[i] Weight decay(batch_norm)      ', args.weight_decay)
